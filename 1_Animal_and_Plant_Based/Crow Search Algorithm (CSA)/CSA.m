function [bestFitness, bestPosition, convergenceCcurve] = CSA(LB, UB, Dim, popSize, maxItr, Cost_Function)
    ...
    fit = arrayfun(@(i) evalCost(X(i,:), Cost_Function), 1:popSize);
    ...
    for t = 2:maxItr
        ...
        fitNew = arrayfun(@(i) evalCost(Xnew(i,:), Cost_Function), 1:popSize);
