...
% function [Male_Jackal_score,Male_Jackal_pos,sh_x,sh_y,Convergence_curve]=GJO(SearchAgents_no,Max_iter,lb,ub,dim,fobj)
...
%             %draw search history
%             sh_x(1,(30*(l)+i))=Positions(i,1);
%             sh_y(1,(30*(l)+i))=Positions(i,2);
        end
