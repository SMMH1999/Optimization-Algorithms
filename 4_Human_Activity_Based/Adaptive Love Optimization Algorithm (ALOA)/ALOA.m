function [bestFitness, bestPosition, convergenceCurve] = ALOA(lb, ub, dim, nPop, maxItr, objFun)
    % =========================================================================
    % Adaptive Lion Optimization Algorithm (ALOA)
    % =========================================================================
    % Description:
    % An enhanced LOA with adaptive attraction coefficient.
    % Attraction strength decreases exponentially over iterations,
    % enabling a dynamic balance between exploration and exploitation.
    %
    % INPUTS:
    ...
    %
    % Tunable Parameters:
    % alpha0 : Initial attraction coefficient
    % beta   : Decay rate
    % =========================================================================
    ...
    for t = 1:maxItr
        ...
        alpha = alpha0 * exp(-beta * t);
        attraction = 1 ./ (1 + alpha * fitness);
