function [Best_Elite_Fitness, Best_Elite_Position, Convergence_Curve] = DSFO_2(LB, UB, Dim, Predator_no, Max_iter, Cost_Function, Function_Number, costFunctionDetails)
    ...
    for Itr = 1:Max_iter
        ...
        for i = 1:Prey_no
            ...
            % Sardine_Position(i, :) = rand() * (Injured_Sardine_Position - Sardine_Position(i, :) + Attack_Power);
