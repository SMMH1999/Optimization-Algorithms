function [bestFitness, bestPosition, convergenceCurve] = ORCAS_3(lowerBound, upperBound, dimension, numAgents, maxIterations, costFunction, functionIndex, details)
    ...
    for it = 1:maxIterations
        ...
        for i = 1:nPop
            [pop(i).Position, ~] = Opposite(lowerBound, upperBound, pop(i).Position, costFunction, functionIndex, details);
        end
