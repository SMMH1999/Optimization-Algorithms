function [Best_Elite_Fitness, Best_Elite_Position, Convergence_Curve] = DSFO(LB, UB, Dim, Predator_no, Max_iter, Cost_Function, Function_Number, costFunctionDetails)
